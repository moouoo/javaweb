...
%>
  <p>
    ...
    5-2.특정문자열의 위치값 검색(indexOf()) : <%=atom.lastIndexOf("o") %> / <%-- ${fn:lstIndexOf(atom, 'o') } --%><br />
    	atom변수에 기억되어 있는 'o'문자의 위치를 모두 출력해보자.<br />
    	<c:set var="cnt" value="0" />
    	<c:forEach begin="0" end="${fn:length(atom)-1 }" var="i">
    	...
    	<br />
    	atom변수값의 'o'문자 개수는? <font color="red">${cnt }</font>
	...
	7.문자열분리(split(변수,분리할문자)) : 문자분리후에는 분리된 문자들을 변수에 담아줘야 한다.<br />
		예) atom변수의 문자중 'o'문자를 기준으로 분리해보세요?<br />
